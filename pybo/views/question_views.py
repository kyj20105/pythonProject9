...
def _list():
    ...
    if so == 'recommend':
        sub_query = db.session.query(
            question_voter.c.queqstion_id, func.count('*').label('num_voter'))\
            .group_by(question_voter.c.queqstion_id).subquery()
        question_list = Question.query \
            .outerjoin(sub_query, Question.id == sub_query.c.queqstion_id) \
